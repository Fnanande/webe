...
$.ajax({
    url: "template/ajax.php", type: 'post', data: {itemid: $(this).data("id")}, success: function (result) {
        ...
        fetch('http://localhost:8080/database/cart.php', {
            method: 'POST',
            headers: {
            ...
            .then(data => {
                stripe = Stripe('pk_test_51KgqLGARCavAM8yD956BsUVsmAyKH3392mbuRHo2sVyHBRh7nNLrLLKv9qeHC9kl6aAvGORdxEJLmf1SqxNYI8Py00ueq1Sxyi')
